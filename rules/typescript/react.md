...
```typescript
// features/users/state/use-user-list.ts
...
```typescript
// features/users/state/use-user-by-id.ts
...
```typescript
// features/users/state/use-create-user.ts
...
```typescript
// features/users/state/use-delete-user.ts
...
```typescript
// features/users/state/user-ui-store.ts
...
```typescript
// features/users/containers/users-page.tsx
...
```typescript
// features/users/components/user-list-view/user-list-view.tsx
...
```typescript
// features/users/components/user-card/user-card.tsx
...
features/users/
  ...
  state/
    ...
    use-delete-user.ts
    user-ui-store.ts
  index.ts                ← export { UsersPage, UserEditPage }
```
...
- [ ] Feature's `index.ts` exports only public-facing containers — internal components are private
